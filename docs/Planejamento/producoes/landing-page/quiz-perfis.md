# Quiz · Copies dos 4 Perfis

> **Fonte única de verdade.** Edite aqui quando quiser mudar as copies e peça pro Claude sincronizar com a landing page (`Campanhas/essencia/landing page/index.html`).

Cada perfil é definido pela resposta da **Pergunta 1** do quiz (a dor principal). Cada copy tem 3 blocos:

1. **Reconhecimento** · "Seu perfil é: X"
2. **Diagnóstico** · o que trava essa pessoa
3. **Ponte pra sessão** · o que acontece na sessão diagnóstica

---

## Perfil A

**Gatilho (P1):** "Já tentei várias dietas e sempre volto para onde estava"

**Título:** Seu perfil é: a que já tentou de tudo.
...
**Gatilho (P1):** "Sei o que devo comer, mas não consigo colocar em prática"

**Título:** Seu perfil é: a que sabe, mas não consegue sozinha.
...
**Gatilho (P1):** "Tenho uma relação difícil com a comida: ansiedade, culpa ou compulsão"

**Título:** Seu perfil é: a que briga com a comida.

**Corpo:** Culpa depois de comer, ansiedade antes, compulsão no meio. Você já entendeu: não é sobre força de vontade. É sobre uma relação que precisa ser reconstruída. Dieta não faz isso. Acompanhamento comportamental faz.
...
**Gatilho (P1):** "Quero emagrecer sem abrir mão de ter uma vida normal"

**Título:** Seu perfil é: a que quer resultado sem abrir mão de viver.
...
- **Mudar regra de perfil:** o gatilho está ligado ao `data-v` exato do botão no quiz. Se mudar a opção da P1 na landing, atualize aqui também.
- **Adicionar perfil:** adicione uma nova seção `## Perfil X` com os 3 blocos e peça pro Claude sincronizar.
